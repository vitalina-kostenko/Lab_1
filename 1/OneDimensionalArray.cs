...
public class OneDimensionalArray
{
    ...
    {
        get => (index >= 0 && index < array.Length) ? array[index] : throw new Exception("Index is out of range.");
        set => array[index >= 0 && index < array.Length ? index : throw new Exception("Index is out of range.")] = value;
    }
    ...
    //    return max;
    //}
    public int FindMax() => array.Length == 0 ? throw new Exception("Array is empty.") : array.Max();
    ...
    //    return min;
    //}
    public int FindMin() => array.Length == 0 ? throw new Exception("Array is empty.") : array.Min();
}
